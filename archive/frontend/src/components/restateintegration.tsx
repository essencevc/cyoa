...
const texts = [
  {
    id: 1,
    header: "Restate Powers Your Stories",
    subheader:
      "Our distributed system efficiently processes story elements in parallel",
    icon: <Star />,
  },
  {
    id: 2,
    header: "AI-Driven Generation",
    subheader:
      "Restate coordinates with AI to analyze preferences and generate personalized stories",
    icon: <Clock />,
  },
  {
    id: 3,
    ...
    subheader:
      "Your unique interactive story is processed and ready to explore",
    icon: <MessageCircle />,
  },
];

export function RestateIntegration() {
  const itemVariants = {
    ...
    <div className="relative h-full w-full max-w-[32rem] transform-gpu rounded-lg border bg-white [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] dark:bg-black dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] md:max-h-[500px]">
      ...
      >
        ...
        <div className="flex w-full flex-col items-start border-t border-neutral-200 p-4 dark:border-neutral-800">
          <h2 className="text-xl font-semibold">Generate Complex Stories</h2>
          <p className="text-base font-normal text-neutral-500 dark:text-neutral-400">
            Restate powers the generation of complex stories with durable
            promises and workflows
          </p>
        </div>
      </motion.div>
    </div>
